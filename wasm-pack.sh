...
# Build wasm package
# Don't forget to remove panic_immediate_abort if you want to debug
RUSTFLAGS='-C target-feature=+atomics,+bulk-memory,+mutable-globals' wasm-pack build -t no-modules --release \
